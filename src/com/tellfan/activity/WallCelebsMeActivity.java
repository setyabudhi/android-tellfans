...
public class WallCelebsMeActivity extends Main implements OnClickListener, OnTouchListener ,OnItemClickListener {
    ...
    private Runnable loadMoreListItems = new Runnable() {			
		...
		public void run()  {
			...
			try {
				...
				HttpResponse datax = HttpRequest.get3(url + "?whattype=shoutout&page="+initialpage+"&limit="+itemsPerPage+"&isViewedby=celebtoceleb&ViewID="+TellFan.getInstance().getUser().id+"&targetID="+id());
	...
	public void onPhotos(View view){
		...
		Bundle b = getIntent().getExtras();   
		Intent act = new Intent(this, WallCelebmeMediaActivity.class);
		act.putExtra("rootmessageid", id());
