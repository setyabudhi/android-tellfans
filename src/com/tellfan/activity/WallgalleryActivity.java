...
public class WallgalleryActivity extends Main implements OnClickListener, OnItemSelectedListener, OnItemClickListener, OnTouchListener {
...
//        photos.setVisibility(View.GONE);
        ...
        try {
	        HttpResponse datax = HttpRequest.get3(url + "?whattype=gallerybyid&id="+albumid+"&messagetypeid="+messagetypeid+"&clientid="+TellFan.getInstance().getUser().id);
			/** Handling XML */
