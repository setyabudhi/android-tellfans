...
public class WallFansMeActivity extends Main implements OnClickListener, OnTouchListener ,OnItemClickListener {
	...
	public void onClick(View arg0) {
		if(arg0.getId() == R.id.imageView2){
			...
			userData.put("currentclientid", ""+TellFan.getInstance().getUser().id);
    ...
    private Runnable loadMoreListItems = new Runnable() {			
		...
		public void run()  {
			...
			try {
				...
				HttpResponse datax = HttpRequest.get3(url + "?whattype=shoutout&page="+initialpage+"&limit="+itemsPerPage+"&isViewedby=celeb&ViewID="+TellFan.getInstance().getUser().id+"&targetID="+rootmessageid);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		// TODO Auto-generated method stub
		 ...
		 //if (!(textSum.getText() == null || textSum.getText().toString().trim().length()==0)){
				Intent act = new Intent(this, WallCelebsMeCommentActivity.class);
	...
	public void onPhotos(View view){
		Bundle b = getIntent().getExtras();   
		Intent act = new Intent(this, WallFansmeMediaActivity.class);
