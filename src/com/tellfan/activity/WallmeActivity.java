...
public class WallmeActivity extends Main implements OnClickListener, OnTouchListener ,OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wallme);
    ...
    private Runnable loadMoreListItems = new Runnable() {			
		...
		public void run()  {
			...
			try {
				...
				HttpResponse datax = HttpRequest.get3(url + "?whattype=shoutout&page="+initialpage+"&limit="+itemsPerPage);
				//HttpResponse datax = HttpRequest.get3(url + "?whattype=shoutout&page="+1+"&limit="+10);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		// TODO Auto-generated method stub
		 ...
		 //if (!(textSum.getText() == null || textSum.getText().toString().trim().length()==0)){
				Intent act = new Intent(this, WallmecommentActivity.class);
